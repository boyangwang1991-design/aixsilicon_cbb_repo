...
set OUT [file normalize "../../build/eda/lut64_run"]
set_app_var target_library $PDKDB
set_app_var link_library "* $PDKDB"
analyze -format sverilog [list [file join $RTLDIR popcount.sv] [file join [file dirname [info script]] lut64_top.sv]]
elaborate popcount_lut64
link
